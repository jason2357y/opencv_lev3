...
class MainWindow(QWidget):
    ...
    def getPhotoPath(self):
        fname = QFileDialog.getOpenFileName(self, 'open file', r'.\img')
...
class EditWindow(QWidget):
    ...
    def editImage(self, mainwindow):
        try:
            ...
            QMessageBox.question(self, '에러', '너비나 높이가 숫자가 아님니다', QMessageBox.Ok)
        ...
        try:
            ...
            img_edited.save(r'.\img\img_edited.png', 'PNG')
            mainwindow.imagepath = r'.\img\img_edited.png'
